...
assertEqual(STICKER_CATEGORIES[0].previewImage, "/stickers/1s.svg", "basic preview should use 1s");
assertEqual(STICKER_CATEGORIES[1].previewImage, "/stickers/2s.svg", "deco preview should use 2s");
