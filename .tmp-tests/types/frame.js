...
const LEGACY_HORIZONTAL = { width: 719, height: 483 };
const LEGACY_VERTICAL = { width: 483, height: 719 };
// 화면/저장 기준으로 사용할 정확한 2:3 캔버스
export const EXACT_HORIZONTAL_CANVAS = { width: 720, height: 480 };
export const EXACT_VERTICAL_CANVAS = { width: 480, height: 720 };
const HORIZONTAL = LEGACY_HORIZONTAL;
const VERTICAL = LEGACY_VERTICAL;
const scaleSlotToCanvas = (slot, from, to) => {
...
const normalizeFrameLayout = (layout) => {
...
export const FRAME_LAYOUTS = Object.fromEntries(Object.entries(RAW_FRAME_LAYOUTS).map(([frameType, layout]) => [
    frameType,
